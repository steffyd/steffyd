...
*   **Directory Structure:** The project is organized into `services/` directory.
...
*   **Infrastructure as Code:** Terraform is the primary tool for provisioning all cloud resources (Cloud Run, GCS, IAM).
